    ...
    QWidget(0, f), curAlignment(0), m_node(node)
{
    ...
    QString copyrightText5G = QChar(0xA9) + QString("2020 ") + QString(tr("The 5G developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightText5G);
